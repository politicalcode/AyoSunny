...
import com.ayoview.sample.textview.badge.TabActivity;
import com.ayoview.sample.textview.verticalbanner.VerticalBannerActivity;
...
public class TextViewDemoActivity extends BaseDemoMenuActivity{
    ...
    protected Leaf[] getMenus() {
        Leaf[] leaves = {
                new Leaf("Button初学", "", V_Button.class),
