...
public class V_ImageView extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sp_ac_imageview);
		
		final Button btn_alpha_more = this.findViewById(R.id.btn_alpha_more);
		final Button btn_alpha_less = this.findViewById(R.id.btn_alpha_less);
		final Button btn_next = this.findViewById(R.id.btn_next);
		
		final ImageView imageWhole = this.findViewById(R.id.imageWhole);
		final ImageView imagePart = this.findViewById(R.id.imagePart);
