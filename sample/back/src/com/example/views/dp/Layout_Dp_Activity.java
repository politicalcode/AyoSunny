 ...
 *
 */
public class Layout_Dp_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_layout_dp);
		...
		sb.append("\n");
		sb.append("dm.widthPixels = " + dm.widthPixels + "--(" + SBViewUtils.getScreenWidthDP(this) + "dp)\n");
		sb.append("dm.heightPixels = " + dm.heightPixels + "--(" + SBViewUtils.getScreenHeightDP(this) + "dp)\n");
		
		setText(R.id.tv_dpi, sb.toString());
		
		//----宽度：
		View v = findViewById(R.id.tv_width);
		int screenWidthDp = SBViewUtils.getScreenWidthDP(this);
		SBViewUtils.setViewWidth(this, v, screenWidthDp);
